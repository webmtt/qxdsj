  ...
  <div class="server-products-list">
    <div class="hot-content">
      <div class="hot-content-header">
        <span>库表资源交换详情</span>
        <!-- <span>LIBRARY TABLE RESOURCE EXCHANGE DETAILS</span> -->
      </div>
...
import { tableResourceDetails } from "@/api/northCloud.js";
export default {
  data() {
    return {
      chart: null,
  ...
  methods: {
    initEcharts() {
      this.$nextTick(() => {
        this.chart = echarts.init(document.getElementById("table"));
        this.option = {
          // title: {
          //   text: '目录累计访问量'
          // },
