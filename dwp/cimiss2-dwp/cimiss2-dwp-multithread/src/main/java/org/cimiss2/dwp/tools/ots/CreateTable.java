...
//    	SURF_WEA_CHN_REP_TAB
    	delTable("RADI_MUL_CHN_HOR_TAB");
//    	delTable("SEVP_WEFC_TYP_WT_TAB");
    	createTable(ots, "RADI_MUL_CHN_HOR_TAB");
//    	createTable(mysql, "SEVP_WEFC_TYP_WT_TAB","D_ELE_ID");
        
    	//deleteTables();
//    	createTable(mysql, tableName, secondaryKeyName);
    }
