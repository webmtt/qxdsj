...
//                    System.out.println(record);
    ...
    public Worker newWorker(OTSClient client, String dataTableName, String statusTableName, String streamId, String workerId) {
        ...
        ILeaseManager<ShardLease> leaseManager = new LeaseManager<ShardLease>(client, streamConfig.getStatusTableName(), leaseSerializer, new RetryStrategy(), 100);
        Worker worker = new Worker(workerId, new ClientConfig(), streamConfig, new RecordProcessorFactory(workerId, client), Executors.newCachedThreadPool(), leaseManager);
        return worker;
    }
