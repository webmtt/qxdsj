 ...
 * @author zhaoxiaojun
 * ---------------------------------------------------------------------------------
 * @Title: GressWeightMainThread.java
 * @Package cma.cimiss2.dpc.indb.agme.dc_agme_gress_weight
 * @Description: 牧草干鲜比
 * <p>
 * <pre>
 ...
 * ------------ ----------- --------------------------
 * 2019年10月11日 下午2:42:42  Initial creation.
 * </pre>
 */
public class GressWeightMainThread {
    ...
    public static void start(){
        ...
        String ctS = StartConfig.ctsCode("S003_cts_code");
        String sodSs[] = StartConfig.sodCodes("S003_sod_code");
        String reportSods[] = StartConfig.reportSodCodes();
        String valuetables[] = StartConfig.valueTables("S003_value_table_name");
...
//            codeMap.setReport_sod_code(reportSods[i]);
        ...
        if(StartConfig.fileLoop() == 0) {
            for (int i = 0; i < threadCount; i++) {
                executor.execute(new GressWeightSubThread(diQueues));
            }
        }
    }
}
