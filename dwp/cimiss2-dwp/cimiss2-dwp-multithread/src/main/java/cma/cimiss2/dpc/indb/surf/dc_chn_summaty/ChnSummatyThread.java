package cma.cimiss2.dpc.indb.surf.dc_chn_summaty;

import cma.cimiss2.dpc.decoder.agme.DecodeGrassNutrition;
...
import cma.cimiss2.dpc.decoder.surf.DecodeChnSummaty;
import cma.cimiss2.dpc.decoder.tools.common.EI;
import cma.cimiss2.dpc.decoder.tools.common.RestfulInfo;
import cma.cimiss2.dpc.decoder.tools.common.StatDi;
import cma.cimiss2.dpc.decoder.tools.enumeration.Action;
import cma.cimiss2.dpc.decoder.tools.enumeration.EIEventType;
import cma.cimiss2.dpc.indb.agme.dc_grass_nutrition.Service.GrassNutritionService;
import cma.cimiss2.dpc.indb.surf.dc_chn_summaty.Service.ChnSummatyService;
...
public class ChnSummatyThread implements Runnable{
    ...
    public static String cts_code = StartConfig.ctsCode("S014_cts_code");
    public static String sod_code = StartConfig.sodCode("S014_sod_code");
    public ChnSummatyThread(BlockingQueue<StatDi> diQueues) {
        ChnSummatyService.diQueues = diQueues;
    }
    ...
    public void run() {
        ...
        try {
            ...
            channel.queueDeclare(StartConfig.queueName("S014_RabbitMQ.queueName"), true, false, false, null);
            // 定义消费者
            ...
            channel.basicConsume(StartConfig.queueName("S014_RabbitMQ.queueName"), false, consumer);
        } catch (Exception e) {
    ...
    private Action processMsg(String message,Date recv_time, StringBuffer loggerBuffer) {
        ...
        // 数据解码返回解码结果集
        DecodeChnSummaty decodeChnSummaty = new DecodeChnSummaty();
        parseResult = decodeChnSummaty.decode(file);
        // 判断是否解码成功
        if (parseResult.isSuccess()) {
            ...
            if (StartConfig.getDatabaseType() == 2) {
                action = ChnSummatyService.processSuccessReport(parseResult, recv_time, topic, loggerBuffer, filename);
            } else {
                return Action.RETRY;
            }
