 ...
 * @author zhaoxiaojun
 * ---------------------------------------------------------------------------------
 * @Title: ZslObserveMainThread.java
 * @Package cma.cimiss2.dpc.indb.agme.dc_agme_zsl_observe
 * @Description: 草地蒸散量
 * <p>
 * <pre>
 ...
 * ------------ ----------- --------------------------
 * 2019年10月10日 下午2:42:42  Initial creation.
 * </pre>
 */
public class ZslObserveMainThread {
    ...
    public static void start(){
        ...
        String ctS = StartConfig.ctsCode("S006_cts_code");
        String sodSs[] = StartConfig.sodCodes("S006_sod_code");
        String reportSods[] = StartConfig.reportSodCodes();
        String valuetables[] = StartConfig.valueTables("S006_value_table_name");
...
//            codeMap.setReport_sod_code(reportSods[i]);
        ...
        if(StartConfig.fileLoop() == 0) {
            for (int i = 0; i < threadCount; i++) {
                executor.execute(new ZslObserveSubThread(diQueues));
            }
        }
    }
}
