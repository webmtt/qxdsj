package cma.cimiss2.dpc.indb.surf.dc_chn_gener.Service;
...
public class ChnGenerService {
    ...
    private static void insert_db(List<Chnmrbc> parseResult, Connection connection, Date recv_time, StringBuffer loggerBuffer, String filename, String cts_code) {
        ...
        try {
            String sql = " INSERT INTO " + StartConfig.valueTable("S016_value_table_name") + "("
                    + "D_RECORD_ID, V01301, V01300, NOTE_GENERAL_EVENTID, NOTE_MONTH, NOTE_GENERAL_EVENT)"
                    + "VALUES (?,?,?,?,?,?)";
            ...
            for (Chnmrbc chnmrbc : parseResult) {
                ...
                try {
                    ...
                    ps.setString(ii++, chnmrbc.getNoteGeneralEventid());
                    ps.setString(ii++, chnmrbc.getNoteMonth());
                    ps.setString(ii++, chnmrbc.getNoteGeneralEvent());
                } catch (Exception e) {
                    e.printStackTrace();
