...
/**
 * 沙尘（暴）数据集(v1.0)
 * Created by zxj on 2019/11/06.
 */
public class ChnDstMainThread {

    private static String configPropertiesFile = "D:\\G.9901.0001.R002_config.properties";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                executor.execute(new ChnDstThread(topic));
            }
