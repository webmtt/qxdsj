 ...
 * @description：近地面通量——湍流数据表
 * @modified By：
 * @version: 1.0$
 */
public class FXiliTurbTabMainThread {
//    private static String configPropertiesFile = "D:\\解码文件\\V.0011.0001.S001_config.properties";
//
//    /**
//     * create by zxj
...
//                excutor.execute(new FXiliTurbTabSubThread(topic));
//            }
...
public static void start(){
        ...
        String ctS = StartConfig.ctsCode("R008_cts_code");
        String sodSs[] = StartConfig.sodCodes("R008_sod_code");
        String reportSods[] = StartConfig.reportSodCodes();
        String valuetables[] = StartConfig.valueTables("R008_hc_value_table_name");
...
//            codeMap.setReport_sod_code(reportSods[i]);
        ...
        if(StartConfig.fileLoop() == 0) {
            for (int i = 0; i < threadCount; i++) {
                executor.execute(new FXiliTurbTabSubThread(diQueues));
            }
        }
    }
