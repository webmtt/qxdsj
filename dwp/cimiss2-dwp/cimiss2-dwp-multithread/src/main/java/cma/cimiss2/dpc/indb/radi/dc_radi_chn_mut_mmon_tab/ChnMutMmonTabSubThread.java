package cma.cimiss2.dpc.indb.radi.dc_radi_chn_mut_mmon_tab;

import cma.cimiss2.dpc.decoder.bean.ParseResult;
import cma.cimiss2.dpc.decoder.bean.ReportError;
import cma.cimiss2.dpc.decoder.bean.radi.RadiChnMutMmonTab;
import cma.cimiss2.dpc.decoder.radi.ChnMutMmonTab;
import cma.cimiss2.dpc.decoder.tools.common.EI;
import cma.cimiss2.dpc.decoder.tools.common.RestfulInfo;
import cma.cimiss2.dpc.decoder.tools.common.StatDi;
import cma.cimiss2.dpc.decoder.tools.enumeration.Action;
import cma.cimiss2.dpc.decoder.tools.enumeration.EIEventType;
import cma.cimiss2.dpc.indb.radi.dc_radi_chn_mut_mmon_tab.service.ChnMutMmonTabService;
import cma.cimiss2.dpc.indb.utils.PollDoc;
...
/**
 * @author ：YCK
 * @date ：Created in 2019/10/29 0029 10:05
 * @description：
 * @modified By：
 * @version: 1.0$
 */
public class ChnMutMmonTabSubThread implements Runnable{
...
//
//    public ChnMutMmonTabSubThread(String topic) {
//        this.topic = topic;
//    }
//    @Override
//    public void run() {
...
//            String path = "C:\\Users\\piesat\\Desktop\\Moon";        //要遍历的路径
//            //获取其file对象
//            List list = PollDoc.getNames(path);
//            for (Object lists : list) {
//                System.out.println(lists);
//                Action action  = processMsg(lists.toString(), recv_time,loggerBuffer);
//            }
//
//        } catch (Exception e) {
//            e.printStackTrace();
...
public static String fileN = null;
    public static String cts_code = StartConfig.ctsCode("R015_cts_code");
    public static String sod_code = StartConfig.sodCode("R015_sod_code");
    public ChnMutMmonTabSubThread(BlockingQueue<StatDi> diQueues) {
    ...
    public void run() {
        ...
        try {
            ...
            channel.queueDeclare(StartConfig.queueName("R015_rabbitMQ_queueName"), true, false, false, null);
            // 定义消费者
            ...
            channel.basicConsume(StartConfig.queueName("R015_rabbitMQ_queueName"), false, consumer);
        } catch (Exception e) {
            ...
            if(ei == null) {
                ...
                if(StartConfig.isSendEi()) {
                    ...
                    ei.setKIndex("连接信息：[主机："+rabbitMQConfig.getHost()+",用户名："+rabbitMQConfig.getUser()+",密码："+rabbitMQConfig.getPassword()+
                            ",端口号："+rabbitMQConfig.getPort()+"，对列："+StartConfig.queueName("R015_rabbitMQ_queueName")+"]");
    ...
    public Action processMsg(String message, Date recv_time, StringBuffer loggerBuffer) {
        ...
        // 数据解码返回解码结果集
        ChnMutMmonTab chnMutMmonTab = new ChnMutMmonTab();
        parseResult = chnMutMmonTab.decode(file);
        // 判断是否解码成功
        if (parseResult.isSuccess()) {
            ...
            if (StartConfig.getDatabaseType() == 2) {
                action = ChnMutMmonTabService.processSuccessReport(parseResult, recv_time, cts_code, loggerBuffer, filename);
            } else {
                return Action.RETRY;
            }
