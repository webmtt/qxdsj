package cma.cimiss2.dpc.indb.radi.cd_radi_bmb_dat_tab;

import cma.cimiss2.dpc.decoder.bean.ParseResult;
import cma.cimiss2.dpc.decoder.bean.ReportError;
import cma.cimiss2.dpc.decoder.bean.radi.*;
import cma.cimiss2.dpc.decoder.radi.BmbDatTab;
import cma.cimiss2.dpc.decoder.tools.common.EI;
import cma.cimiss2.dpc.decoder.tools.common.RestfulInfo;
import cma.cimiss2.dpc.decoder.tools.common.StatDi;
import cma.cimiss2.dpc.decoder.tools.enumeration.Action;
import cma.cimiss2.dpc.decoder.tools.enumeration.EIEventType;
import cma.cimiss2.dpc.indb.radi.cd_radi_bmb_dat_tab.service.BmbDatTabService;
...
//                String pathname = "D://RADI_MUL_NM_ST_FTM[_T0005_201308].txt";
//                byte[] fileByte = null;
...
public static String fileN = null;
    public static String hour_cts_code = StartConfig.ctsCode("R016_hour_cts_code");
    public static String min_cts_code = StartConfig.ctsCode("R016_min_cts_code");
    public static String sod_code = StartConfig.sodCode("R016_sod_code");
    public BmbDatTabSubThread(BlockingQueue<StatDi> diQueues) {
    ...
    public void run() {
        ...
        try {
            ...
            channel.queueDeclare(StartConfig.queueName("R016_rabbitMQ_queueName"), true, false, false, null);
            // 定义消费者
            ...
            channel.basicConsume(StartConfig.queueName("R016_rabbitMQ_queueName"), false, consumer);
        } catch (Exception e) {
            ...
            if(ei == null) {
                ...
                if(StartConfig.isSendEi()) {
                    ...
                    ei.setKIndex("连接信息：[主机："+rabbitMQConfig.getHost()+",用户名："+rabbitMQConfig.getUser()+",密码："+rabbitMQConfig.getPassword()+
                            ",端口号："+rabbitMQConfig.getPort()+"，对列："+StartConfig.queueName("R016_rabbitMQ_queueName")+"]");
    ...
    public Action processMsg(String message, Date recv_time, StringBuffer loggerBuffer) {
        ...
        // 数据解码返回解码结果集
        BmbDatTab bmbDatTab = new BmbDatTab();
        Map<String,Object> resultMap = bmbDatTab.decode(file,filename);
        List<RadiBmbHourDatTab> radiBmbHourDatTabList = null;
        List<RadiBmbMinDatTab> radiBmbMinDatTabList = null;
        decodingInfo= (ParseResult<String>) resultMap.get("decodingInfo");
        // 判断是否解码成功
        if (decodingInfo.isSuccess()) {
            radiBmbHourDatTabList = (List<RadiBmbHourDatTab>) resultMap.get("radiBmbHourDatTabList");
            radiBmbMinDatTabList = (List<RadiBmbMinDatTab>) resultMap.get("radiBmbMinDatTabList");
            ...
            if (StartConfig.getDatabaseType() == 2) {
                action = BmbDatTabService.processSuccessReport(radiBmbHourDatTabList,radiBmbMinDatTabList, recv_time, hour_cts_code,min_cts_code, loggerBuffer, filename);
            } else {
                return Action.RETRY;
            }
