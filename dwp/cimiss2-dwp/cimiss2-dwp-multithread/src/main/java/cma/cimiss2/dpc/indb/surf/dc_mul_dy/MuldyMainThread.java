...
/**
 * 包神铁路沿线数据服务
 * Created by zxj on 2019/10/24.
 */
public class MuldyMainThread {

    private static String configPropertiesFile = "D:\\E.3800.0004.S011_config.properties";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                executor.execute(new MuldyThread(topic));
            }
