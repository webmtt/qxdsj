package cma.cimiss2.dpc.indb.other;

import cma.cimiss2.dpc.decoder.tools.common.FileDi;
import cma.cimiss2.dpc.indb.floor.FLOORSubThread;
...
//        int count = StartConfig.getThreadCount();
        ...
        for (int i = 0; i < count; i++) {
            executor.execute(new OTHERSubThread(diQueues));
        }
        //启动入库ATS子线程
