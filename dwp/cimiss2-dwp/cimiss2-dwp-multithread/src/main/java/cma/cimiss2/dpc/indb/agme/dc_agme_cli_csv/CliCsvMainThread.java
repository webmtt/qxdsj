 ...
 * ------------ ----------- --------------------------
 * 2019年10月15日 下午2:42:42  Initial creation.
 * </pre>
 */
public class CliCsvMainThread {
    ...
    public static void start(){
        ...
        String ctS = StartConfig.ctsCode("S007_cts_code");
        String sodSs[] = StartConfig.sodCodes("S007_sod_code");
        String reportSods[] = StartConfig.reportSodCodes();
        String valuetables[] = StartConfig.valueTables("S007_value_table_name");
...
//            codeMap.setReport_sod_code(reportSods[i]);
        ...
        if(StartConfig.fileLoop() == 0) {
            for (int i = 0; i < threadCount; i++) {
                executor.execute(new CliCsvSubThread(diQueues));
            }
        }
    }
}
