 ...
 * @description：呼和浩特紫外辐射数据数据表
 * @modified By：
 * @version: 1.0$
 */
public class HhhtUrayTabMainThread {
//    private static String configPropertiesFile = "D:\\M.0001.0001.S001_config.properties";
//
//    /**
//     * create by zxj
...
//                excutor.execute(new HhhtUrayTabSubThread(topic));
//            }
...
public static void start(){
        ...
        String ctS = StartConfig.ctsCode("R010_cts_code");
        String sodSs[] = StartConfig.sodCodes("R010_sod_code");
        String reportSods[] = StartConfig.reportSodCodes();
        String valuetables[] = StartConfig.valueTables("R010_value_table_name");
...
//            codeMap.setReport_sod_code(reportSods[i]);
        ...
        if(StartConfig.fileLoop() == 0) {
            for (int i = 0; i < threadCount; i++) {
                executor.execute(new HhhtUrayTabSubThread(diQueues));
            }
        }
    }
