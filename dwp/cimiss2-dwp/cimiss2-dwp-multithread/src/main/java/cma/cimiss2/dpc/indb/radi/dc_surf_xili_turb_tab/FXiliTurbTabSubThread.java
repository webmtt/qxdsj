package cma.cimiss2.dpc.indb.radi.dc_surf_xili_turb_tab;
...
import cma.cimiss2.dpc.decoder.radi.FXiliTurbTab;
import cma.cimiss2.dpc.decoder.tools.common.EI;
import cma.cimiss2.dpc.decoder.tools.common.RestfulInfo;
import cma.cimiss2.dpc.decoder.tools.common.StatDi;
import cma.cimiss2.dpc.decoder.tools.enumeration.Action;
import cma.cimiss2.dpc.decoder.tools.enumeration.EIEventType;
import cma.cimiss2.dpc.indb.radi.dc_surf_xili_turb_tab.service.FXiliTurbTabService;
...
//                String pathname = "D:\\解码文件\\PBL_FLUX_S_54102_201004.TXT";
//                byte[] fileByte = null;
...
public static String fileN = null;
    public static String cts_code = StartConfig.ctsCode("R008_cts_code");
    public static String sod_code = StartConfig.sodCode("R008_sod_code");
    public FXiliTurbTabSubThread(BlockingQueue<StatDi> diQueues) {
    ...
    public void run() {
        ...
        try {
            ...
            channel.queueDeclare(StartConfig.queueName("R008_rabbitMQ_queueName"), true, false, false, null);
            // 定义消费者
...
//                    }
            ...
            channel.basicConsume(StartConfig.queueName("R008_rabbitMQ_queueName"), false, consumer);
        } catch (Exception e) {
            ...
            if(ei == null) {
                ...
                if(StartConfig.isSendEi()) {
                    ...
                    ei.setKIndex("连接信息：[主机："+rabbitMQConfig.getHost()+",用户名："+rabbitMQConfig.getUser()+",密码："+rabbitMQConfig.getPassword()+
                            ",端口号："+rabbitMQConfig.getPort()+"，对列："+StartConfig.queueName("R008_rabbitMQ_queueName")+"]");
    ...
    private Action processMsg(String message, Date recv_time, StringBuffer loggerBuffer) {
        ...
        // 数据解码返回解码结果集
        FXiliTurbTab fXiliTurbTab = new FXiliTurbTab();
        Map<String,Object> resultMap = fXiliTurbTab.decode(file,filename);
        List<SurfXiliTurbHcTab> surfXiliTurbHcTabList = null;
        List<SurfXiliTurbTlTab> surfXiliTurbTlTabList = null;
        decodingInfo= (ParseResult<String>) resultMap.get("decodingInfo");
        // 判断是否解码成功
        if (decodingInfo.isSuccess()) {
            surfXiliTurbHcTabList = (List<SurfXiliTurbHcTab>) resultMap.get("surfXiliTurbHcTabList");
            surfXiliTurbTlTabList = (List<SurfXiliTurbTlTab>) resultMap.get("surfXiliTurbTlTabList");
            ...
            if (StartConfig.getDatabaseType() == 2) {
                action = FXiliTurbTabService.processSuccessReport(surfXiliTurbHcTabList,surfXiliTurbTlTabList, recv_time, sod_code, loggerBuffer, filename);
            } else {
                return Action.RETRY;
            }
