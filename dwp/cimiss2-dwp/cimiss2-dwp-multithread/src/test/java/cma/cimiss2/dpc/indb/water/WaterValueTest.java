package cma.cimiss2.dpc.indb.water;
...
//        try {
//        	// 消息的value
        	String filePath = "D:/testData/201810150200.xml";
...
//        String topic = "A.0043.0002.S001";
        ...
        try {
//        	String filePath = "/Users/zm/data/201810150200.xml";//原始文件所在路径（必填）
        	File file = new File(filePath);
        	String line = null;
        	...
        	String FileName = "201810150200.xml";//资料文件名（必填）
