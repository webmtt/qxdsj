package cma.cimiss2.dpc.indb.LDP;
...
//        String topic = "B.0016.0003.S001";
//        BufferedReader bufr = null;
//        try {
//        	// 消息的value
//            String filePath = "D:/testData/ADTD_light_20181028.txt";
//            File file = new File(filePath);
//            String line = null;
//            StringBuffer sb = new StringBuffer();
//            bufr = new BufferedReader(new InputStreamReader(new FileInputStream(file), "GBK"));
...
//                ProducerRecord<String, Bytes> record = new ProducerRecord<>(topic, Bytes.wrap(b));
...
//		}
     ...
     // StringSerializer用来将String对象序列化成字节数组
        ...
        BufferedReader bufr = null;
        try {
        	String filePath = "D:/testData/ADTD_light_20181028.txt";//原始文件所在路径（必填）
        	File file = new File(filePath);
        	String line = null;
            StringBuffer sb = new StringBuffer();
        	...
        	String TYPE = "B.0016.0003.S001";//TYPETag =1四级资料编码;TYPETag = 0 自定义资料编码（必填）
        	...
        	String FileName = "ADTD_light_20181028.txt";//资料文件名（必填）
            ...
            String js = JSONObject.toJSONString(map);//获取json字符串
            
            //异步发送消息
            ProducerRecord<String, Bytes> record = new ProducerRecord<>(TYPE, js, Bytes.wrap(buf));
            producer.send(record);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
