package cma.cimiss2.dpc.indb.sevpwarning;
...
public class ForcastWarningTest {
...
//        String topic = "M.0058.0004.S001";
        String topic="L.0433.0000.R000";
        try {
        	// 消息的value
//        	String filePath = "D:/logs/sevpwarning/BJ_IS_FOGW_YEL_201811131630.pdf";
            String filePath = "/HTData/FTP/SEVP/L.0433.0000.R000";
    		...
    		js.put("GHC", null);
    		js.put("CAC", null);
    		js.put("STime", "20181113163000");
    		js.put("ETL", null);
    		js.put("FileName", "BJ_IS_FOGW_YEL_201811131630.pdf");
