package cma.cimiss2.dpc.indb.dayValue;
...
//        String topic = "A.0016.0001.S001";
//        BufferedReader bufr = null;
//        try {
//        	// 消息的value
////            String filePath = "D:/testData/Z_SURF_C_BEPK_20181001120000_O_AWS_DAY.TXT";
...
//		}
     ...
     // StringSerializer用来将String对象序列化成字节数组
        ...
        BufferedReader bufr = null;
        try {
        	String filePath = "D:/testData/Z_SURF_C_BEPK_20181001120000_O_AWS_DAY.TXT";//原始文件所在路径（必填）
        	File file = new File(filePath);
        	String line = null;
            StringBuffer sb = new StringBuffer();
            bufr = new BufferedReader(new InputStreamReader(new FileInputStream(file), "UTF-8"));
        	...
        	String TYPE = "A.0016.0001.S001";//TYPETag =1四级资料编码;TYPETag = 0 自定义资料编码（必填）
        	...
        	String FileName = "Z_SURF_C_BEPK_20181001120000_O_AWS_DAY.TXT";//资料文件名（必填）
        	String BBB = null;//更正标识eg：CCX。数据更正标识，可选标志，CC为固定代码；x取值为A～X；如果资料不是更正报
        	int PQC = 0;//质量控制标识 =1 已质控 =0 未质控
            String NasPath = "D:/testData/Z_SURF_C_BEPK_20181001120000_O_AWS_DAY.TXT";//原始文件所在路径（必填）
