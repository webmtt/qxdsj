...
//		ProducerRecord<String,byte[]> msgtar = new ProducerRecord<String, byte[]>("" ,"J.0010.0001.R002",.getBytes());//风廓线雷达产品
		String topic = "J.0010.0001.R002";//风廓线雷达产品
		String filePath = "F:\\dongao\\data\\54511_middle_echo_201812070705.png";
//		String filePath = "/htht/tools/test/data/54511_middle_echo_201812070705.png";
		...
		js.put("FileName", "54511_middle_echo_201812070705.png");
