package cma.cimiss2.dpc.indb.surfrain;
...
/**
 * 
* @ClassName: SurfRainTest.java
* @Description: 水利局降水测试类
*
*@version: v1.0.0
 * @author haozk
* @date: 2019年6月24日 上午10:59:45
 *
 */
public class SurfRainTest {
...
//        String topic = "Z.2001.0006.S001";
//        BufferedReader bufr = null;
//        try {
//        	// 消息的value
//            String filePath = "D:/logs/surfrain/201810150200.xml";
////            String filePath = "D:/testData/Z_SURF_C_BEPK_20181001120000_O_AWS_DAY-[CCa].TXT";
...
//        String topic = "A.0043.0002.S001";
        BufferedReader bufr = null;
        try {
        	String filePath = "/Users/zm/data/Z_SURF_C_BEPK_20181001120000_O_AWS_DAY-[CCa].TXT";//原始文件所在路径（必填）
        	File file = new File(filePath);
        	String line = null;
            StringBuffer sb = new StringBuffer();
            bufr = new BufferedReader(new InputStreamReader(new FileInputStream(file), "UTF-8"));
        	...
        	// kafka消息key(模拟)
        	Map<String, Object> map = new HashMap<String, Object>();//用于存储kafka消息key的集合
        	
        	int TypeTag = 1;//是否为四级资料编码：1 是；0否（必填）
        	String TYPE = "Z.2001.0006.S001";//TYPETag =1四级资料编码;TYPETag = 0 自定义资料编码（必填）
        	...
        	String FileName = "Z_SURF_C_BEPK_20181001120000_O_AWS_DAY-[CCa].TXT";//资料文件名（必填）
        	String BBB = null;//更正标识eg：CCX。数据更正标识，可选标志，CC为固定代码；x取值为A～X；如果资料不是更正报
        	int PQC = 0;//质量控制标识 =1 已质控 =0 未质控
            String NasPath = "/Users/zm/data/Z_SURF_C_BEPK_20181001120000_O_AWS_DAY-[CCa].TXT";//原始文件所在路径（必填）
