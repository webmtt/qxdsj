package cma.cimiss2.dpc.indb.sunshine;
...
public class SunshineTest {
	...
	public static void main(String[] args) {
     ...
     // StringSerializer用来将String对象序列化成字节数组
        ...
        try {
        	// 消息的value
//            String filePath = "D:/testData/Z_SURF_C_BEPK_20180102120000_O_AWS-SS_DAY.TXT";
            File file = new File("D:/testData/Z_SURF_C_BEPK_20180102120000_O_AWS-SS_DAY.TXT");
