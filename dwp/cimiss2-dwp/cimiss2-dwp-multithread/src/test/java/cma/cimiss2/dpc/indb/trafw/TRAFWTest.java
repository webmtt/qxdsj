package cma.cimiss2.dpc.indb.trafw;
...
//        String topic = "A.0008.0001.S001";
//        BufferedReader bufr = null;
//        try {
//        	// 消息的value
//            String filePath = "D:/testData/Z_SURF_C_BEPK-REG_20181109000000_O_AWS-RD_FTM.txt";
...
//        String topic = "A.0043.0002.S001";
        BufferedReader bufr = null;
        try {
        	String filePath = "D:/testData/Z_SURF_C_BEPK-REG_20181109000000_O_AWS-RD_FTM.txt";//原始文件所在路径（必填）
        	File file = new File(filePath);
        	String line = null;
            StringBuffer sb = new StringBuffer();
            bufr = new BufferedReader(new InputStreamReader(new FileInputStream(file), "UTF-8"));
        	...
        	String TYPE = "A.0008.0001.S001";//TYPETag =1四级资料编码;TYPETag = 0 自定义资料编码（必填）
        	...
        	String FileName = "Z_SURF_C_BEPK-REG_20181109000000_O_AWS-RD_FTM.txt";//资料文件名（必填）
