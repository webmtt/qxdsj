...
CREATE TABLE `radi_chn_mut_mpen_tab`  (
  ...
  `V14320_stime` decimal(7, 0) NULL DEFAULT NULL COMMENT '总辐射最大辐照度出现起始时间',
  `V14320_etime` decimal(7, 0) NULL DEFAULT NULL COMMENT '总辐射最大辐照度出现截止时间',
  `V14308_1` decimal(6, 0) NULL DEFAULT NULL COMMENT '净全辐射最大辐照度',
  `V14308_stime` decimal(7, 0) NULL DEFAULT NULL COMMENT '净全辐射最大辐照度出现时间',
  `V14308_etime` decimal(7, 0) NULL DEFAULT NULL COMMENT '净全辐射最大辐照度出现时间',
  `V143_st_1` decimal(6, 0) NULL DEFAULT NULL COMMENT '垂直直接辐射最大辐照度',
  `V143_st_stime` decimal(7, 0) NULL DEFAULT NULL COMMENT '垂直直接辐射最大辐照度出现时间',
