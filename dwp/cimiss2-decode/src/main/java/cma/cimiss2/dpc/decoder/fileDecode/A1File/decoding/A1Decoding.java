package cma.cimiss2.dpc.decoder.fileDecode.A1File.decoding;

import cma.cimiss2.dpc.decoder.bean.ParseResult;
import cma.cimiss2.dpc.decoder.bean.radi.RadiDigChnMulTab;
import cma.cimiss2.dpc.decoder.fileDecode.A1File.bean.A1OverHeadInfo;
...
public class A1Decoding implements IFileDecoding {
    ...
    public Map<String,Object> assemblyData(File file,String sunCtsCode,String dayCtsCode,String hourCts,String monthCts,String meadowCts,String filename, List<RadiDigChnMulTab> Rlist){
        ...
        while(entries.hasNext()){//日值处理
            ...
            sunLightValueTab.setD_DATA_ID(sunCtsCode);
