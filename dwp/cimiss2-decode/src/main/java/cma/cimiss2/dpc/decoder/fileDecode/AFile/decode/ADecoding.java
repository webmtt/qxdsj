package cma.cimiss2.dpc.decoder.fileDecode.AFile.decode;



import cma.cimiss2.dpc.decoder.bean.ParseResult;
import cma.cimiss2.dpc.decoder.bean.radi.RadiDigChnMulTab;
import cma.cimiss2.dpc.decoder.fileDecode.AFile.bean.AOverHeadInfo;
...
public class ADecoding implements IFileDecoding {
     ...
     */
    @Override
    public  Map<String,Object> assemblyData(File file, String sunlightCts,String dayCtsCode, String hourCts, String monthCts, String meadowCts, String filename, List<RadiDigChnMulTab> Rlist){
...
//        System.out.println(filename+"数据条数："+aDecoding.size());
        ...
        while(entries.hasNext()){//日值处理
            ...
            sunLightValueTab.setD_DATA_ID(sunlightCts);
