...
public class SurfREGEtl1 extends AbstractEtl<SurfaceObservationDataReg> {
            ...
            if(observationTime.getMinutes() == 00 ) {
                for(int j = 55; j < 60; j++) {
                    ...
                    if(date.getMinutes() >= 56){
                    	...
                    	dataMinPre.put("Q13011", bean.getPrecipitationEveryMinutes().get(59).getQuality().get(0).getCode());
