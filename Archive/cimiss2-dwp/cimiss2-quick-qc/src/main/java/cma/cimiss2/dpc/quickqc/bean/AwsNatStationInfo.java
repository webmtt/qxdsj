...
* *******************************************************************************************<br>
* <b>Description: 国家站参数配置文件实体类 </b><br> 
* @author wuzuoqiang 
* @version 1.0
* @Note
* <b>ProjectName:</b> cimiss2-quick-qc
* <br><b>PackageName:</b> cma.cimiss2.dpc.quickqc.bean
* <br><b>ClassName:</b> AwsNatStationInfo
* <br><b>Date:</b> 2019年6月19日 下午2:58:18
 */
public class AwsNatStationInfo extends BaseStationInfo {
	private List<MeteoElementObsStateInfo> meteoElementObsStateInfos;

	public AwsNatStationInfo() {
		super();
	...
	public MeteoElementObsStateInfo findMeteoElementObsStateInfo(MeteoElement element) {
		List<MeteoElementObsStateInfo> list = meteoElementObsStateInfos.stream()
				.filter(ele -> ele.getElement() == element).collect(Collectors.toList());
