...
public class otsHorBolt extends BaseRichBolt {
    ...
    public void execute(Tuple input) {
        ...
        if (input.getSourceStreamId().equals("PERF-HOR-Bolt")) {
//            System.out.println("REG-HOR-Bolt=============");
            ...
            try {
                ...
                if (horList != null && horList.size() > 0) {
                    loadHor = precipitationObservationDataRegEtl.load(horList, horTableHelper, false);
                }
                ...
                buffer.append("入库 " + horTable + " 失败:" + "precipitationObservationDataRegEtl.getFile().getPath()" + "\n" +
                        "错误原因:" + e.getMessage() + "\n");
            }
            if (horList != null && horList.size() > 0) {
