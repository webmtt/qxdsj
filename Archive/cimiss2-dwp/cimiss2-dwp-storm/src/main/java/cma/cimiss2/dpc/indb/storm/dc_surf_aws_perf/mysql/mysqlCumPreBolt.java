...
public class mysqlCumPreBolt extends BaseRichBolt {
    ...
    public void execute(Tuple input) {
        if (input.getSourceStreamId().equals("PERF-CUM-PRE-Bolt")) {
//            System.out.println("REG-HOR-Bolt=============");
        	System.out.println("perf_cum_pre_tuple_id=" + input.getMessageId());
            ...
            try {
                ...
                loadCumPre = precipitationObservationDataRegEtl.load(cumPreList, "rdb");
                ...
                buffer.append("入库 " + cumPreTable + " 失败:" + precipitationObservationDataRegEtl.getFile().getPath() + "\n" +
                        "错误原因:" + e.getMessage() + "\n");
            }finally {
