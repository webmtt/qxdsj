...
#--------------------------------------------------------------------------------------
PRONAME='dpc_upar_hkflash.jar'
PORTNUM='4106'
CONFNAME='config/dpc_upar_hkflash.properties'
#--------------------------------------------------------------------------------------
SCRIPTNAME=$0
#Process number
...
start() {
  ...
  then
    ...
    nohup java -jar $PRONAME $PORTNUM $CONFNAME config/Light_5501_setups.properties config/Light_5501_TAB.xml >/dev/null 2>&1 &
