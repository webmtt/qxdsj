package cma.cimiss2.dpc.indb.cawn.dc_cawn_reg;
...
import cma.cimiss2.dpc.decoder.cawn.DecodeREG;
import cma.cimiss2.dpc.decoder.tools.common.EI;
import cma.cimiss2.dpc.decoder.tools.common.RestfulInfo;
import cma.cimiss2.dpc.decoder.tools.common.StatDi;
import cma.cimiss2.dpc.decoder.tools.enumeration.EIEventType;
import cma.cimiss2.dpc.indb.cawn.dc_cawn_reg.service.*;

/**
 * -------------------------------------------------------------------------------
 * <br>
 * @Title:  FileLoopThread.java   
 * @Package cma.cimiss2.dpc.indb.cawn.reg
		...
		while(true) {
			if(files.size() > 0) {
				...
				if(file.exists() && file.isFile()) {
					...
					ParseResult<REG> parseResult = decodeREG.DecodeFile(file);
						...
						if(parseInfo != null) {
							...
							if(ei == null) {
								...
								if(StartConfig.isSendEi() && Integer.parseInt(ei.getEVENT_LEVEL()) > 0 ) {
									...
									ei.setKObject("cma.cimiss2.dpc.indb.cawn.reg.FileLoopThread");
