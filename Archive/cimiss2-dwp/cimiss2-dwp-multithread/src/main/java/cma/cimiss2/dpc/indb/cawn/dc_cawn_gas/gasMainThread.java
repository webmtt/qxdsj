 ...
 * @Description:    TODO(大气成分气溶胶观测数据（BUFR格式）	大数据平台	G.0016.0002.R001)
 * @author: zhangliang
 * @date:   2019年11月15日 13:42
 * @Copyright: 2019 www.cma.gov.cn Inc. All rights reserved.
 * 注意：本内容仅限于国家气象信息中心内部传阅，禁止外泄以及用于其他的商业目
 */
public class gasMainThread {
...
//		args=new String[] {"5003","config/dpc_surf_cawn_gas.properties "};//轮训测试用
		if(args.length < 1) {
