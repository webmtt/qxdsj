...
import cma.cimiss2.dpc.indb.upar.dc_upar_wind_rada_nc.service.*;
/**
 * ************************************
...
//                        action = OTSService.processSuccessReport(pr, rece_time, fileName, log);
                    ...
                    if (action == DataBaseAction.CONNECTION_ERROR) {
                    	...
                    	infoLogger.info("move file: " + fileName);
                    ...
                    if (parseInfo != null) {
                        ...
                        if (ei == null) {
                            ...
                            ei.setKObject("cma.cimiss2.dpc.indb.upar.dc_upar_wind_rada_nc.FileLoopThread");
