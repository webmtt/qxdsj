...
import cma.cimiss2.dpc.indb.cawn.dc_cawn_met80.service.DbService;
import cma.cimiss2.dpc.indb.cawn.dc_cawn_met80.service.OTSService;
		...
		while(true) {
			if(files.size() > 0) {
				...
				if(file.exists() && file.isFile()) {
					...
					DecodeMet80 decodeMet80 = new DecodeMet80();
					ParseResult<String> parseResult = decodeMet80.decodeFile(filepath, ",", recv_time);
