...
public class DbService {
	...
	public static DataBaseAction processSuccessReport(ParseResult<AveObservationSandTowerData> parseResult, Date recv_time, String fileN, StringBuffer loggerBuffer, String filepath) {
		// 获取数据库连接
...
//			connection = JdbcUtilsSing.getInstance("config/sand_soi/z_sand_soi_db_config.xml").getConnection();
	 ...
	 */
	private static DataBaseAction insert_db(List<AveObservationSandTowerData> list, Connection connection, Date recv_time, String fileN, StringBuffer loggerBuffer, String filepath) {
		...
		// 获取数据库连接
		 //connection =JdbcUtilsSing.getInstance(dbPath).getConnection();
			String sql = "INSERT INTO "+StartConfig.valueTable()+"(D_RECORD_ID, "
  +" D_DATA_ID,D_IYMDHM,D_RYMDHM,D_UPDATE_TIME,D_DATETIME,V01301,V01300,V05001,V06001, "
  +"  V07001,V_ACODE,V04001,V04002,V04003,V04004,V04005,V04006,V04016,V12001_01,V12001_02,V12001_04, "
  +"  V12001_10,V12001_20,V13003_01,V13003_02,V13003_04,V13003_10,V13003_20,V11002_01,V11002_02,V11002_04, "
  +"  V11002_10,V11002_20,V11001_01,V11001_02,V11001_04,V11001_10,V11001_20,V_BBB,D_SOURCE_ID)VALUES " 
  +"(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
			...
			for (int i = 0; i < list.size(); i++) {
				...
				pStatement.setString(ii++,  StationCodeUtil.stringToAscii(sandTowerBean.getStationNumberChina()));//区站号(数字)
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getLatitude())));//纬度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getLongitude())));//经度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getHeightOfSationGroundAboveMeanSeaLevel())));//测站海拔高度
				pStatement.setString(ii++, StationInfo.getAdminCode(sandTowerBean.getStationNumberChina(), acodeNo));//中国行政区划代码
...
*/				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getTimeInterval())));//观测时间间隔
				
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getTemperature_1())));//1米温度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getTemperature_2())));//2米温度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getTemperature_4())));//4米温度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getTemperature_10())));//10米温度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getTemperature_20())));//20米温度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getHumidity_1())));//1米湿度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getHumidity_2())));//2米湿度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getHumidity_4())));//4米湿度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getHumidity_10())));//10米湿度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getHumidity_20())));//20米湿度
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getWindSpeed_1())));//1米风速
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getWindSpeed_2())));//2米风速
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getWindSpeed_4())));//4米风速
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getWindSpeed_10())));//10米风速
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getWindSpeed_20())));//20米风速
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getWindDirection_1())));//1米风向
				pStatement.setBigDecimal(ii++, new BigDecimal("999998"));//2米风向
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getWindDirection_4())));//4米风向
				pStatement.setBigDecimal(ii++, new BigDecimal("999998"));//10米风向
				pStatement.setBigDecimal(ii++, new BigDecimal(String.valueOf(sandTowerBean.getWindDirection_20())));//20米风向
				...
				di.setHEIGHT(String.valueOf(sandTowerBean.getHeightOfSationGroundAboveMeanSeaLevel()));
