package cma.cimiss2.dpc.indb.cawn.dc_cawn_vis;
...
import cma.cimiss2.dpc.indb.cawn.dc_cawn_vis.FileLoopThread;
import cma.cimiss2.dpc.indb.common.LoopFolderThread;

/**
 * 
 * <br>
 * @Title:  VISMainThread.java   
 * @Package cma.cimiss2.dpc.indb.cawn.vis   
 * @Description:    TODO(大气成分气溶胶能见度（VIS）	大数据平台	G.0002.0009.R001
 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年3月20日 下午5:50:41   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 *
 ...
 // 声明一个缓存队列，存放轮询到的文件路径
    ...
    public static void main(String[] args) throws SQLException, InterruptedException {
        if(args.length < 1) {
 			...
 			//File file = new File("config/cawn_vis_config.properties");
	     ...
	     // 消息中间件
	     	if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new VISMultSubThread(diQueues));
		        }
	        }
