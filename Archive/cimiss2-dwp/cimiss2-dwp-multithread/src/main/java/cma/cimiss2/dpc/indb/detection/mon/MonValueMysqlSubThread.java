...
import cma.cimiss2.dpc.indb.core.etl.mysqlETL.MonEtl;
...
public class MonValueMysqlSubThread extends BaseThread<RadiMulChnMonTab> {
    ...
    private MonEtl dayValueEtl;

    public MonValueMysqlSubThread() {
        dayValueEtl = IocBuilder.ioc(ConfigurationManager.getConfigPath()).get(MonEtl.class);
...
//      File file = new File(message.split(":")[1]);
        ...
        ParseResult<RadiMulChnMonTab> result = dayValueEtl.extract(file);
