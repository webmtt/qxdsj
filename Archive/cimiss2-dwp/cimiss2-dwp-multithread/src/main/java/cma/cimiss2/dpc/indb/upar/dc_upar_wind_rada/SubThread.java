...
//                }
            	...
            	public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                    ...
                    // cuihongyuan 2019-12-13
                    if(file.length()  > StartConfig.maxFileSize){
        				infoLogger.info("\n File is too large(" + file.length() + "byte), ignore it! Filepath is: " + fileN);
                    ...
                    if (action == Action.ACCEPT) {
                        // 入库成功确认消息
                        messageLogger.info("ack message : " + fileName);
                        channel.basicAck(envelope.getDeliveryTag(), false);
            ...
            if (ei == null) {
                ...
                ei.setKObject("cma.cimiss2.dpc.indb.upar.wind_rada.SubThread");
