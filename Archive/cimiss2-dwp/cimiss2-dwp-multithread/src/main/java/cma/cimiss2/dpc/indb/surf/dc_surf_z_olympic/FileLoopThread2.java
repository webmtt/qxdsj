...
import cma.cimiss2.dpc.indb.surf.dc_surf_z_olympic.service.DbService;
/**
 * 
 * *******************************************************************************************<br>
 ...
 * @version 0.0.1
 */
public class FileLoopThread2 {
	    public static final Logger infoLogger = LoggerFactory.getLogger("loggerInfo");
	    public static final Logger messageLogger = LoggerFactory.getLogger("messageInfo");

	    public FileLoopThread2(BlockingQueue<StatDi> diQueues, BlockingQueue<StatDi> diQueues2) {
	        DbService.setDiQueues(diQueues);
	        DbService.setDiQueues2(diQueues2);
	    }
