package cma.cimiss2.dpc.indb.upar.dc_upar_wind_rada_nc;
...
import cma.cimiss2.dpc.decoder.upar.DecodeWindProfileNC;
import cma.cimiss2.dpc.indb.upar.dc_upar_wind_rada_nc.service.DbService;
 ...
 * @Description: 风廓线雷达资料解析--ascii--线程--接受消息
...
//                }
            ...
            if (ei == null) {
                ...
                ei.setKObject("cma.cimiss2.dpc.indb.upar.dc_upar_wind_rada_nc.SubThread");
    ...
    private Action processMsg(String fileN,String fileName, Date rece_time) {
        DecodeWindProfileNC windRada = new DecodeWindProfileNC();
        ParseResult<WindProfileRada> pr = windRada.decodeWindProFileNC(fileName);
