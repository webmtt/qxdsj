...
import cma.cimiss2.dpc.indb.core.etl.mysqlETL.NbrCntEtl;
...
public class NbrCntValueMysqlSubThread extends BaseThread<NafpChnNbrcntPreTab> {
    ...
    private NbrCntEtl dayValueEtl;

    public NbrCntValueMysqlSubThread() {
        dayValueEtl = IocBuilder.ioc(ConfigurationManager.getConfigPath()).get(NbrCntEtl.class);
...
//      File file = new File(message.split(":")[1]);
        ...
        ParseResult<NafpChnNbrcntPreTab> result = dayValueEtl.extract(file);
