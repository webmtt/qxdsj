...
public class RadiHourMainThread {
	static {
		BufrConfig.init();
	}
	...
	public static void main(String[] args) {
		...
		//本地调试   消息
		//String[] args={"1","config/radi_bufr_hour_config.properties"};
		...
		if(args.length < 1) {
			...
			if(args.length <2) {
 			...
 			File file = new File(args[1].trim()); //  config/dpc_radi_bufr_hour.properties
