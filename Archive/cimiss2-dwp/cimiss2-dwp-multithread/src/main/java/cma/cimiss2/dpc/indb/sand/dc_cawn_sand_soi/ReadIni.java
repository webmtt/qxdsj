 ...
 * @Description:    TODO(沙尘暴土壤湿度sql配置文件解析)
 * 
 * <pre>
 * SOFTWARE HISTORY
...
public class ReadIni extends IniReader {
	 ...
	 */
	public static final String SECTION_SOI = "SOI";
	/**
...
//				is = ReadIniPheno.class.getResourceAsStream("/agme_config/sql/z_agme_soil.ini");
				is = new FileInputStream(System.getProperty("user.dir") + "/config/sand_soi/z_sand_soi.ini");
