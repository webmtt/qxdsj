...
import cma.cimiss2.dpc.indb.cawn.dc_cawn_rad_fld.service.DbService;
import cma.cimiss2.dpc.indb.cawn.dc_cawn_rad_fld.service.OTSService;
		...
		while(true) {
			if(files.size() > 0) {
				...
				if(file.exists() && file.isFile()) {
					...
					DecodeRadfld decodeRadfld = new DecodeRadfld();
					ParseResult<String> parseResult = decodeRadfld.decodeFile(filepath, ",", recv_time);
