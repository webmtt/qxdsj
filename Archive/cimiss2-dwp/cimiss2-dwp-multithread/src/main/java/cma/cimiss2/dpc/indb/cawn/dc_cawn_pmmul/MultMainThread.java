 ...
 * @Package cma.cimiss2.dpc.indb.cawn.pummul
 * @Description:    大气成分气溶胶PM10/PM2.5/PM1质量浓度（PMMUL）主启动线程
 * 大气成分	大气成分气溶胶PM10/PM2.5/PM1质量浓度（PMMUL）	大数据平台	G.0002.0008.R001
 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年3月2日 下午2:34:20   wangzunpeng    Initial creation.
 * </pre>
 * 
 * @author wangzunpeng
 */
public class MultMainThread {
    ...
    public static void main(String[] args) throws SQLException, InterruptedException {
        if(args.length < 1) {
 			...
 			//File file = new File("config/cawn_pmmul_config.properties");
