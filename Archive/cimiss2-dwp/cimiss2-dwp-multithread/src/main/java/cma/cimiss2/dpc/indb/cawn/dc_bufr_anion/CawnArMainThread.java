 ...
 *   <li> 定义参考以下文档
 *    <ol>
 *      <li> 大气负离子浓度数据表（BUFR格式） G.0016.0001.R001 </a>
 *    </ol>
 *   </li>
 * </ul>
 * 
 ...
 * ------------ ----------- --------------------------
 * 2019年4月19日 下午3:41:35   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 * @version 0.0.1
			...
			ExecutorService executor = Executors.newFixedThreadPool(threadCount);
	     	...
	     	if(StartConfig.fileLoop() == 0) {
				for (int i = 0; i < threadCount; i++) {
					executor.execute(new SubThread(cts_code, diQueues)); //可以处理的资料:大气负离子资料数据 G.0016.0001.R001
				}
	     	}
