 ...
 * 
 * <br>
 * @Title:  SandTowerMainThread.java   
 * @Package cma.cimiss2.dpc.indb.sand.tower
 * @Description:(沙尘暴铁塔平均场数据处理线程)
 * 大气成分	沙尘暴铁塔平均场（ATW）	大数据平台	G.0001.0001.R001

 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2017年12月14日 上午10:48:07   dengyongliang    Initial creation.
 * </pre>
 * 
 ...
 *
 */
public class SandTowerMainThread {
    ...
    public static void main(String[] args) throws SQLException, InterruptedException {
        if(args.length < 1) {
 			...
 			//File file = new File("config/cawn_sand_atw_config.properties");
	        ...
	        if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new SandTowerSubThread(diQueues));
		        }
	        }
