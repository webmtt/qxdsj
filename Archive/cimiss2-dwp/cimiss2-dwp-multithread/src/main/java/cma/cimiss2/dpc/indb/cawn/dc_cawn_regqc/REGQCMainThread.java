...
import cma.cimiss2.dpc.indb.cawn.dc_cawn_regqc.FileLoopThread;
import cma.cimiss2.dpc.indb.common.LoopFolderThread;

/**
 * 
 * <br>
 * @Title:  REGQCMainThread.java   
 * @Package cma.cimiss2.dpc.indb.cawn.regqc   
 * @Description:    TODO(大气成分反应性气体质量控制信息文件	大数据平台	G.0002.0030.R001
 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年4月11日 下午4:38:26   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 *
...
public class REGQCMainThread {
    ...
    public static void main(String[] args) throws SQLException, InterruptedException {
        if(args.length < 1) {
 			...
 			//File file = new File("config/cawn_regqc_config.properties");
	        ...
	        // 消息中间件
	     	if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new REGQCMultSubThread(diQueues));
		        }
	     	}
