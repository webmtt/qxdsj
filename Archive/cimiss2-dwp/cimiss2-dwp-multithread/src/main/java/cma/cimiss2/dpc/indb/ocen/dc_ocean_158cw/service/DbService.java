package cma.cimiss2.dpc.indb.ocen.dc_ocean_158cw.service;
...
import cma.cimiss2.dpc.decoder.cawn.DecodeMet80;
...
public class DbService {
	...
	public static String V_TT = PropertiesUtil.getTT() ;
	...
	public static void main(String[] args) {
		...
		String filepath = "C:\\BaiduNetdiskDownload\\test\\G.0002.0015.R001-MET\\G.0002.0015.R001_del\\2019110101\\Z_CAWN_I_52859_20191101000000_O_MET-FLD-MET80.TXT";
...
//		action = DbService.processSuccessReport(parseResult, recv_time, filepath, loggerBuffer, filepath);
		System.out.println("insertDBService over!"+action);
	 ...
	 * @Description: 大气成分气象要素80米梯度塔原始文件（MET80）解码方法
	 */
...
//										if(ColVal.containsKey("V_BBB"))
//											v_bbb = ColVal.get("V_BBB");
//									}
//								 
...
//								infoLogger.error("Insert record one by one failed: \n" + e1.getMessage() + sqls.get(j));
//							 }
							infoLogger.error("single insert failed: \n" + e.getMessage()+sqls.get(j));
						}
					}
				}catch (Exception e2) {
