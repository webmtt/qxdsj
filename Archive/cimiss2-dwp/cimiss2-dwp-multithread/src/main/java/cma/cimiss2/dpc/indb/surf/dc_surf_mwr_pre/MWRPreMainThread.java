 ...
 * 
 * <br>
 * @Title:  MWRPreMainThread.java   
 * @Package cma.cimiss2.dpc.indb.surf.mwr_pre   
 * @Description:    TODO(水利部降水数据处理主线程)Z.2001.0002.R001
 * 
 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年1月23日 上午10:32:35   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 *
    ...
    public static void main(String[] args) {
    	if(args.length < 1) {
			...
			if(args.length <2) {
 			...
 			//File file = new File("config/surf_mwrpre_config.properties");
	        ...
	        if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new MWRPreMultSubThread(diQueues));
		        }
	        }
