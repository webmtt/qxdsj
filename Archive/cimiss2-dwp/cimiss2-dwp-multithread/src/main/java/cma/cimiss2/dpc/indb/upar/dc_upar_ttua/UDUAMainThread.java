 ...
 * 
 * <br>
 * @Title:  UDUAMainThread.java   
 * @Package cma.cimiss2.dpc.indb.upar.udua   
 * @Description:(飞机高空探测解码入库主线程)
 * 
 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年2月28日 上午9:29:50   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 *
    	...
    	if(args.length < 1) {
	        ...
	        if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new UDUAMultSubThread(diQueues));
		        }
	        }
