package cma.cimiss2.dpc.indb.detection.ten;
...
import cma.cimiss2.dpc.indb.core.etl.mysqlETL.TenEtl;
...
public class TenValueMysqlSubThread extends BaseThread<RadiMulChnTenTab> {
    ...
    private TenEtl dayValueEtl;

    public TenValueMysqlSubThread() {
        dayValueEtl = IocBuilder.ioc(ConfigurationManager.getConfigPath()).get(TenEtl.class);
...
//      File file = new File(message.split(":")[1]);
        ...
        ParseResult<RadiMulChnTenTab> result = dayValueEtl.extract(file);
