 ...
 * 
 * <br>
 * @Title:  CROPXMLMainThread.java   
 * @Package cma.cimiss2.dpc.indb.agme.cropxml   
 * @Description:(农作物XML格式数据处理主线程)
 * 
 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年2月7日 下午1:37:31   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 *
 *
 */
public class CROPXMLMainThread {
    ...
    public static void main(String[] args) {
    	if(args.length < 1) {
			...
			//File file = new File("config/dpc_xml_agme.properties");
	        ...
	        if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new CROPXMLMultSubThread(diQueues));
		        }
	        }
