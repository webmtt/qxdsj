...
import cma.cimiss2.dpc.indb.core.etl.mysqlETL.DayEtl;
...
public class DayValueMysqlSubThread extends BaseThread<RadiMulChnDayTab> {
    ...
    private DayEtl dayValueEtl;

    public DayValueMysqlSubThread() {
        dayValueEtl = IocBuilder.ioc(ConfigurationManager.getConfigPath()).get(DayEtl.class);
...
//      File file = new File(message.split(":")[1]);
        ...
        ParseResult<RadiMulChnDayTab> result = dayValueEtl.extract(file);
