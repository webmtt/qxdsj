...
import cma.cimiss2.dpc.decoder.ocen.Ocen158cwParseConfig;
import cma.cimiss2.dpc.decoder.tools.common.StatDi;
import cma.cimiss2.dpc.indb.ocen.DISubThread;
import cma.cimiss2.dpc.indb.common.LoopFolderThread;
import cma.cimiss2.dpc.indb.ocen.dc_ocean_158cw.FileLoopThread;
...
//    	args=new String[] {"4226","config/dpc_ocen_sea_hyj_tide.properties",
//    			"config/OCEN_158cw_setups.properties","config/OCEN_158cw_TAB.xml"};
    	if(args.length < 1) {
			...
			Ocen158cwParseConfig.config = tableProp;
