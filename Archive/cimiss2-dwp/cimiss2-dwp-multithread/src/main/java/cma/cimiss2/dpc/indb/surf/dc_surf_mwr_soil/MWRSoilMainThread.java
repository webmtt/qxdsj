 ...
 * 
 * <br>
 * @Title:  MWRSoilMainThread.java   
 * @Package cma.cimiss2.dpc.indb.surf.mwr_soil   
 * @Description:    TODO(水利部土壤墒情数据处理主线程)Z.2001.0001.R001
 * 
 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年1月19日 下午3:46:05   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 *
 *
 */
public class MWRSoilMainThread {
    ...
    public static void main(String[] args) {
        if(args.length < 1) {
			...
			if(args.length <2) {
 			...
 			//File file = new File("config/surf_slb_config.properties");
	     ...
	     // 消息中间件
	        if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new MWRSoilMultSubThread(diQueues));
		        }
	        }
