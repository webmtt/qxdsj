 ...
 * 
 * <br>
 * @Title:  ForeignForecastMainThread.java   
 ...
 * ------------ ----------- --------------------------
 * 2018年3月23日 下午5:11:39   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 *
 *
 */
public class ForeignForecastMainThread {
  ...
  */
    public static void main(String[] args) {
        if(args.length < 1) {
 			...
 			//File file = new File("config/sevp_foreign_cityforecast_config.properties");
	        ...
	        // 消息中间件
	     	if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new ForeignForecastMultSubThread(diQueues));
		        }
	     	}
