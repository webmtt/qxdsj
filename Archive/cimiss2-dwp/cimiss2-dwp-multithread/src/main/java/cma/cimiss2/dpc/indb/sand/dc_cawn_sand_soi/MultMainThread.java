 ...
 * @Description:    TODO(沙尘暴土壤湿度主启动线程)
 * 大气成分	沙尘暴土壤湿度（SOI）	大数据平台	G.0001.0010.R001

 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2017年12月29日 下午4:25:16   wangzunpeng    Initial creation.
 * </pre>
 * 
 * @author wangzunpeng
 */
public class MultMainThread {
    ...
    public static void main(String[] args) throws SQLException, InterruptedException {
        if(args.length < 1) {
 			...
 			//File file = new File("config/cawn_sand_soi_config.properties");
