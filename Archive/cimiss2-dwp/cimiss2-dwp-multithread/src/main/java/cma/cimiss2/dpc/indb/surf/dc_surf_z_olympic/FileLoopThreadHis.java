package cma.cimiss2.dpc.indb.surf.dc_surf_z_olympic;
...
import cma.cimiss2.dpc.indb.surf.dc_surf_z_olympic.service.DbServiceHis;
/**
 * 
 * *******************************************************************************************<br>
 ...
 * @version 0.0.1
 */
public class FileLoopThreadHis {
	    public static final Logger infoLogger = LoggerFactory.getLogger("loggerInfo");
	    public static final Logger messageLogger = LoggerFactory.getLogger("messageInfo");

	    public FileLoopThreadHis(BlockingQueue<StatDi> diQueues, BlockingQueue<StatDi> diQueues2) {
	        DbServiceHis.setDiQueues(diQueues);
	        DbServiceHis.setDiQueues2(diQueues2);
	    }
	    
	    public void process(BlockingQueue<String> files) {
	    	// files 一直放一个
	            if (files.size() > 0) {
	                ...
	                if (parseResult.isSuccess()) {
	                    ...
	                    if (StartConfig.getDatabaseType() == 0 || StartConfig.getDatabaseType() == 1) { // xg,rdb
	                        action = DbServiceHis.processSuccessReport(parseResult, filePath, recv);
	                    ...
	                    if (parseInfo != null) {
	                        ...
	                        if (ei == null) {
	                            ...
	                            ei.setKObject("cma.cimiss2.dpc.indb.surf.dc_surf_z_olympic.FileLoopThread");
