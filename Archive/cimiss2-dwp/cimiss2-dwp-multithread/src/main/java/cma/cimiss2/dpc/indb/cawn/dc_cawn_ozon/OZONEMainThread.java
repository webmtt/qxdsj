 ...
 * 
 * <br>
 * @Title:  OZONEMainThread.java
 * @Package cma.cimiss2.dpc.indb.cawn.ozone
 * @Description:(南极臭氧观测资料入库主线程)
 * 大气成分	南极臭氧资料	大数据平台	G.0002.0016.R001

 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年4月13日 上午10:16:39   maxiyue   Initial creation.
 * </pre>
 * 
 * @author maxiyue
 */

public class OZONEMainThread {
    ...
    public static void main(String[] args) throws SQLException, InterruptedException {
        if(args.length < 1) {
 			...
 			//File file = new File("config/cawn_ozon_config.properties");
	        ...
	        // 消息中间件
	     	if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new OZONEMultSubThread(diQueues));
		        }
	     	}
