...
import static cma.cimiss2.dpc.indb.detection.mon.FileUtils.remove;
	            ...
	            for (int i = 0; i < listFiles.length; i++) {
	                ...
	                if (tempFile.isDirectory()) {
	                    ...
	                    if (files.size() > 10000) {
	                    	...
	                    	if(substring.contains("acc")&&substring.contains("ctc.txt")){
//	                    		if(substring.contains("grid_stat_APCP")&&substring.contains("_ctc.txt")){
//	                    			if(substring.contains("grid_stat_APCP")&&substring.contains("_nbrctc.txt")){
