 ...
 * 
 * <br>
 * @Title:  TravelMainThread.java   
 * @Package cma.cimiss2.dpc.indb.sevp.travel   
 * @Description:    TODO(旅游景区气象服务产品资料入库)
 * 旅游景区气象服务产品数据(XML)	大数据平台	M.0043.0002.R001
 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年4月9日 下午1:14:40   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 *
  ...
  */
    public static void main(String[] args) {
        if(args.length < 1) {
 			...
 			//File file = new File("config/sevp_travel_config.properties");
	        ...
	        // 消息中间件
	     	if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new TravelMultSubThread(diQueues));
		        }
	     	}
