...
import cma.cimiss2.dpc.indb.cawn.dc_cawn_reg.FileLoopThread;
import cma.cimiss2.dpc.indb.common.LoopFolderThread;

/**
 * 
 * <br>
 * @Title:  REGMainThread.java   
 * @Package cma.cimiss2.dpc.indb.cawn.reg   
 * @Description:    TODO(大气成分	大气成分反应性气体	大数据平台	G.0002.0017.R001
 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年4月11日 上午9:43:47   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 *
...
public class REGMainThread {
    ...
    public static void main(String[] args) throws SQLException, InterruptedException {
        if(args.length < 1) {
 			...
 			//File file = new File("config/cawn_reg_config.properties");
	     ...
	     // 消息中间件
	     	if(StartConfig.fileLoop() == 0) {
		        for (int i = 0; i < threadCount; i++) {
		            executor.execute(new REGMultSubThread(diQueues));
		        }
	     	}
