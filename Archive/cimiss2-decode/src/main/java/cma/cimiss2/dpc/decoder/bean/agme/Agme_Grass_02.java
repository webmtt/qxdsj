 ...
 * ------------ ----------- --------------------------
 * 2018年9月6日 下午5:00:47   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 * @version 0.0.1
 */
public class Agme_Grass_02 {
	...
	/** nameCN: 生长高度 <br> unit: 厘米<br> BUFR FXY: V71006 <br> descriptionCN: 厘米(cm)	测区牧草平均高度<br> decode rule: 直接取值<br> field rule: 直接赋值<br>. */
	Double heightGrowth;
   ...
   Double heightOfBarometerAboveMeanSeaLevel;
	...
	/**
	 * Gets the height growth.
	 *
	 * @return the height growth
	 */
	public Double getHeightGrowth() {
		return heightGrowth;
	}
	
	/**
	 * Sets the height growth.
	 *
	 * @param heightGrowth the new height growth
	 */
	public void setHeightGrowth(Double heightGrowth) {
