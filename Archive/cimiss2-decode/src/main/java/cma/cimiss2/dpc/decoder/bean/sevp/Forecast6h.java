 ...
 * ------------ ----------- --------------------------
 * 2018年3月6日 上午11:17:34   maxiyue   Initial creation.
 * </pre>
 * 
 * @author maxiyue
 */
public class Forecast6h {
	/**
     * NO: 1.1  <br>
     * nameCN: 区站号 <br>
     * unit: <br>
	...
	List <List6h> list6h  = new ArrayList<>();
	...
	public List<List6h> getList6h() {
		return list6h;
	}
	public void setList6h(List<List6h> list6h) {
		this.list6h = list6h;
	}
	public void put(List6h list6h){
		this.list6h.add(list6h);
	}
