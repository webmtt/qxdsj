 ...
 * 
 * <br>
 * @Title:  RadiMulChnDayTab.java
 * @Package cma.cimiss2.dpc.decoder.bean.radi.sads
 * @Description:    (降水MPR检测评估结果实体类)
 * 
 * <pre>
 * SOFTWARE HISTORY
 ...
 * @author maxiyue
 */
public class RadiMulChnDayTab extends RadiMulChn{
	...
	public Double getObsLvl() {
		return obsLvl;
	}

	public void setObsLvl(Double obsLvl) {
		this.obsLvl = obsLvl;
	}
	...
	public void setFcst(String fcst) {
		this.fcst = fcst;
	}
