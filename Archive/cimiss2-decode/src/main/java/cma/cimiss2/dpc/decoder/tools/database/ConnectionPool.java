 ...
 * @Description:
 * @Aouthor: xzh
 * @create: 2017-11-23 11:41
 */
public class ConnectionPool {
    private  String path;
    private String jdbcDriver = XmlOper.getElementV(XmlOper.getDoc(path), "//config//mysql//driver"); // 数据库驱动
    private String dbUrl = XmlOper.getElementV(XmlOper.getDoc(path), "//config//mysql//url"); // 数据 URL
    private String dbUsername =XmlOper.getElementV(XmlOper.getDoc(path), "//config//mysql//user");// 数据库用户名
    private String dbPassword = XmlOper.getElementV(XmlOper.getDoc(path), "//config//mysql//password"); // 数据库用户密码
