...
public class ZAgmeCrop03 {
	 ...
	 * unit: 1克（g） <br>
	 * BUFR FXY: V71089 <br>
	 * descriptionCN: 计算1000粒平均子粒干重的值 <br>
	 * decode rule: 取值 * 0.01<br>
	 * field rule: 直接赋值<br>
	 */
	 ...
	 * unit: 1克/（千粒.日） <br>
	 * BUFR FXY: V71900 <br>
	 * descriptionCN: 计算单位时间子粒干物质增长量<br>
	 * decode rule: 取值 * 0.01<br>
	 * field rule: 直接赋值 <br>
	 */
	...
	/**
	 * Sets the filling rate.
	 *
	 * @param fillingRate the new filling rate
	 */
	public void setFillingRate(float fillingRate) {
