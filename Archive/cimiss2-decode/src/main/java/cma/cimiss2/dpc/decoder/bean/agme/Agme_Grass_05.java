 ...
 * ------------ ----------- --------------------------
 * 2018年9月6日 下午5:05:55   cuihongyuan    Initial creation.
 * </pre>
 * 
 * @author cuihongyuan
 * @version 0.0.1
 */
public class Agme_Grass_05{
	...
	/** nameCN: 每公顷株丛数 <br> unit: 株/公顷<br> BUFR FXY: V71910<br> descriptionCN: 由100平方米的顷株丛数推算<br> decode rule: 直接取值<br> field rule: 直接赋值<br>. */
	Double NumPlantPerHectare;
	
	/** nameCN: 每公顷总株丛数 <br> unit: 株/公顷<br> BUFR FXY:V71911 <br> descriptionCN: 各分种草每公顷株丛数的总和<br> decode rule: 直接取值<br> field rule: 直接赋值<br>. */
	Double TotalNumPlantPerHectare;
	//头信息
	 /**
    * NO: 1.1  <br>
    * nameCN: 区站号 <br>
   ...
   Double heightOfBarometerAboveMeanSeaLevel;
	...
	/**
	 * Gets the num plant per hectare.
	 *
	 * @return the num plant per hectare
	 */
	public Double getNumPlantPerHectare() {
		return NumPlantPerHectare;
	}
	
	/**
	 * Sets the num plant per hectare.
	 *
	 * @param numPlantPerHectare the new num plant per hectare
	 */
	public void setNumPlantPerHectare(Double numPlantPerHectare) {
		NumPlantPerHectare = numPlantPerHectare;
	}
	
	/**
	 * Gets the total num plant per hectare.
	 *
	 * @return the total num plant per hectare
	 */
	public Double getTotalNumPlantPerHectare() {
		return TotalNumPlantPerHectare;
	}
	
	/**
	 * Sets the total num plant per hectare.
	 *
	 * @param totalNumPlantPerHectare the new total num plant per hectare
	 */
	public void setTotalNumPlantPerHectare(Double totalNumPlantPerHectare) {
		TotalNumPlantPerHectare = totalNumPlantPerHectare;
	}
