 ...
 * @Title:  CawnPM10.java
 * @Package cma.cimiss2.dpc.decoder.bean.cawn
 * @Description:    (大气成分气溶胶PM10质量浓度（PM10）实体类)
 * 
 * <pre>
 * SOFTWARE HISTORY
 * Date         Engineer    Description
 * ------------ ----------- --------------------------
 * 2018年3月21日 下午4:36:20   maxiyue   Initial creation.
 * </pre>
 * 
 * @author maxiyue
 */
public class CawnPM10 extends AgmeReportHeader{
	/**
	 * NO: 1.1  <br>
	 * nameCN: 区站号 <br>
	 * unit: <br>
	 ...
	 */
	Double avgConcentration_24Hour;
	/**
	 * NO: 2.0 <br>
	 * nameCN: 总质量 <br>
	 * unit: <br>
	 ...
	 */
	Double mainRoadRelativeHumidity;
	/**
	 * NO: 3.1 <br>
	 * nameCN: 旁路相对湿度<br>
	 * unit: <br>
	 ...
	 */
	Double sideRoadRelativeHumidity;
	/**
	 * NO: 3.2 <br>
	 * nameCN: 空气相对湿度<br>
	 * unit: <br>
	 ...
	 * descriptionCN: 仪器状态码。
	 */
	String instrumentStatusCode="999998";
	/**
	 * NO: 3.4  <br>
	 * nameCN: 质量浓度<br>
	 * unit: <br>
