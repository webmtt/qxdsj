 ...
 * @version 0.0.1
 */
public class SurfaceObservationMwrpre {
     ...
     * field rule:直接赋值
	 */
	private float  dailyRainfall=999998f;
     ...
     * field rule:直接赋值
	 */
	private float hourlyRainfall=999998f;
     ...
     * field rule:直接赋值
	 */
	private float oneHourRainfall=999998f;
	
	public float getOneHourRainfall() {
		return oneHourRainfall;
	}

	public void setOneHourRainfall(float oneHourRainfall) {
		this.oneHourRainfall = oneHourRainfall;
	}
