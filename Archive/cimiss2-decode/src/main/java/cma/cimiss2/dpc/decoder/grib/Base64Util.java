...
public class Base64Util {
	...
	public static void main(String[] args) {
		//System.out.println("code:" + Base64Util.encode("Pnmicxg2019!dpc"));
//		System.out.println(Base64Util.getPwd("eHVndUAyMDE5IWRwYw=="));
//		System.out.println(Base64Util.decode("eHVndUAyMDE5IWRwYw=="));
		//System.out.println("decode:" + Base64Util.getPwd("eHVndUAyMDE5IWRwYw=="));
		
		System.out.println("code:" + Base64Util.encode("xugu@2019!dpc"));
		System.out.println("decode:" + Base64Util.getPwd("eHVndUAyMDE5IWRwYw=="));
	}
