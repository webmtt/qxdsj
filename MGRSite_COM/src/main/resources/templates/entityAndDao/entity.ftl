...
@Transient
public List
<Long> get${relation.finalTargetTable.entityClassName}IdList() {
    List
    <Long> ${relation.finalTargetTable.entityClassName?uncap_first}IdList = Lists.newArrayList();
        for (${relation.finalTargetTable.entityClassName} ${relation.finalTargetTable.entityClassName?uncap_first}
        : ${relation.targetInstance?uncap_first}) {
        ${relation.finalTargetTable.entityClassName?uncap_first}
        IdList.add(${relation.finalTargetTable.entityClassName?uncap_first}.getId());
        }
        return ${relation.finalTargetTable.entityClassName?uncap_first}IdList;
        }
        @Transient
        public void set${relation.finalTargetTable.entityClassName}IdList(List
        <Long> ${relation.finalTargetTable.entityClassName?uncap_first}IdList) {
            ${relation.targetInstance?uncap_first} = Lists.newArrayList();
            for (Long ${relation.finalTargetTable.entityClassName?uncap_first}Id
            : ${relation.finalTargetTable.entityClassName?uncap_first}IdList) {
            ${relation.finalTargetTable.entityClassName} ${relation.finalTargetTable.entityClassName?uncap_first} =
            new ${relation.finalTargetTable.entityClassName}();
            ${relation.finalTargetTable.entityClassName?uncap_first}
            .setId(${relation.finalTargetTable.entityClassName?uncap_first}Id);
