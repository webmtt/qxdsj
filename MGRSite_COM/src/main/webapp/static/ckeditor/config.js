...
CKEDITOR.editorConfig = function( config ) {
	...
	config.image_previewText='&nbspale';
	...
	if(config.ckfinderPath){
		...
		config.filebrowserWindowWidth = '160';
		config.filebrowserWindowHeight = '120';
	}
/*	config.filebrowserImageUploadUrl ='/mgrsite/notice/attach/imgUplad';*/
};