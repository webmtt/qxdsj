...
function getData (start_time,end_time){
	$.ajax({
		url:'statuserinfo_statUserFieldByTime.action',
		type:'post',
		cache:false,
		dataType:'json',
		async:false,
...
$(function(){
	...
	$('.tlists').datagrid({    
	    ...
	    //url:'stataccess_statClassByTime.action',  
		title:'<div align="center">会员行业分布列表</div>',
	    ...
	    data:tableData,
	    columns:[[    
	        {field:'field',title:'行业分类',width:250,sortable:true,align:'left',halign:'center'},
	        {field:'generalsum',title:'一般会员数',width:170,sortable:true,align:'center',halign:'center'},
	        {field:'coresum',title:'核心会员数',width:170,sortable:true,align:'center',halign:'center'},
	        {field:'sum',title:'总会员数',width:170,sortable:true,align:'center',halign:'center'}
	    ]]    
	});  
