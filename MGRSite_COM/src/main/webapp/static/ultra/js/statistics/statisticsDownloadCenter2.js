...
//				}
				...
				//重绘图表		
				chart.xAxis[0].setCategories(chartData.center);
...
function getData (start_time,end_time){
	$.ajax({
		url:ctx+'/statistics/statisticsDownloadTotal/statCenterPictureByTime',
		type:'post',
		cache:false,
		dataType:'json',
		async:false,
...
function showtable(){
	...
	$('.tlists').datagrid({    
	    ...
	    url:ctx+'/statistics/statisticsDownloadTotal/statCenterListByTime',  
	    data:{
			"start_time":start_time =="" ? "" : start_time,
			"end_time":end_time =="" ? "" : end_time
		},
	    ...
	    columns:[[    
	        ...
	        {field:'center',title:'大院',width:200,sortable:true,halign:'center',align:'center',
