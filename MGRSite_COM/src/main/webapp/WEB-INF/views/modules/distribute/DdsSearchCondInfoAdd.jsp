...
function delAttach(){
	var ftpId=$("#ftpId").val();
	$.ajax({
		url:'${ctx}/dt/ddsFtpInfo/checkJobName',
		type:'GET',
		data:{ftpId:ftpId},
		async: false,
		dataType:'json',
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/dt/ddsSearchCondInfo/add?dataId=${dataId}">新增检索条件</a></li> 
	</ul>
<tags:message content="${message}"/>
 <form:form id="inputForm" name="inputForm" modelAttribute="ddsSearchCondInfo" action="${ctx}/dt/ddsSearchCondInfo/SaveDdsSearchCondInfo" method="post" class="form-horizontal" onsubmit="return check()">
		...
		<div class="control-group">
			...
			<div class="controls">
						<form:textarea path="searchCond" htmlEscape="false" maxlength="600" rows="6"
						 class="input-xxlarge" />
			</div>
		</div>
		<div class="control-group">
