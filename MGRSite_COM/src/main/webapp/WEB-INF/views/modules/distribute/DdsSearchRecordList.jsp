...
<html>
  ...
  <ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/dt/ddsSearchRecordController/list">进行中回调</a></li>
		 <li><a href="${ctx}/dt/ddsSearchRecordController/expiredList?dataId=${dataId} ">历史回调</a></li> 
	</ul>
	<form:form id="form1" action="${ctx}/dt/ddsSearchRecordController/list" method="post" class="breadcrumb form-search">
		...
		<%-- <option value="0" <c:if test="${retriveStatus =='4'}"> selected="selected" </c:if>> </option> --%>
