...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/interdata/interfaceData">API列表</a></li>
		<li class="active"><a href="${ctx}/interdata/interfaceData/form?id=${interfaceData.id}">API${not empty interfaceData.id?'修改':'添加'}查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="interfaceData" action="${ctx}/interdata/interfaceData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="inerfaceId" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">资料编码：</label>
			<div class="controls">
				<form:input path="dataEncoding" htmlEscape="false" maxlength="20" class="input-xlarge "/>
			</div>
		</div>
