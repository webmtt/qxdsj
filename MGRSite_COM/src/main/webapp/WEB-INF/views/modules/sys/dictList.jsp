...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/dict?dictType=${dictType}">字典列表</a></li>
		<shiro:hasPermission name="sys:dict:edit"><li><a href="${ctx}/sys/dict/form?sort=10&dictType=${dict.type}">字典添加</a></li></shiro:hasPermission>
	</ul>
...
<%--    				<a href="${ctx}/sys/dict/form?sort=10&dictType=${dict.type}">添加键值</a>--%>
