...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$.backstretch([
 		      "${ctxStatic}/images/bg1_1.jpg", 
 		      "${ctxStatic}/images/bg2_2.jpg"
...
<body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
       <div class="navbar-inner" style="background:url(${ctxStatic}/images/bg1_03.png)no-repeat 88px 65%">
      </div>
        <div class="container">
...
<%--                    </label>--%>
    ...
    <footer class="white navbar-fixed-bottom">
		Copyright &copy; 2015-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">业务管理站点</a>
