	...
	<script type="text/javascript"> 
		$(document).ready(function() {
			...
			$(".accordion-body a").click(function(){
				...
				///alert(43333);
				//window.open("${ctx}/sys/userInfomation/call?Number=111","_blank",'height=400, width=400, top=0, left=0, toolbar=yes, menubar=yes, scrollbars=yes, resizable=yes,location=yes, status=yes');
