...
<html>
  ...
  <body>
  	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/comparas/form?keyid=${comparas.keyid}">参数修改</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="comparas" method="post" class="form-horizontal">

		<tags:message content="${message}"/>
		<div id="hidden" class="control-group">
			<label class="control-label">键值</label>
			<div class="controls">
				<form:input path="keyid" htmlEscape="false" maxlength="100" class="organization"/></div>
		    </div>
