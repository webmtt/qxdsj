    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#menu a.menu").click(function () {
                ...
                //window.open("${ctx}/sys/userInfomation/call?Number=11");
            ...
            $("#c").hide();
            // var url = '${ctx}/sys/user/getNoBylogin';
            // $.ajax({
            // 	url : url,
            // 	async : true,
            // 	type : 'GET',
            ...
            // 		var no=result.no;
            // 		var no_pass=result.noPassword;
            // 		MYOCX.weblogin(no, no_pass,"10.20.70.50", '8080');
            // 		//alert(Number);
        ...
        function switchUp() {
            if ($("#li1").hasClass("icon-chevron-up")) {
                document.getElementById("div1").style.display = "none";
                $("#li1").removeClass("icon-chevron-up").addClass("icon-chevron-down");
            } else {
                document.getElementById("div1").style.display = "";
                $("#li1").removeClass("icon-chevron-down").addClass("icon-chevron-up");

            }
        }

    </script>
    <!-- <SCRIPT FOR=MYOCX EVENT=PSTNCall(Number,Worknum)>
	//这里实现来电弹屏
	alert(Number);
	window.open("${ctx}/sys/userInfomation/call?Number="+Number,"_blank",'height=600, width=800, top=0, left=0, toolbar=yes, menubar=yes, scrollbars=yes, resizable=yes,location=yes, status=yes'); 
</SCRIPT> -->
</head>
<body>
<!-- <OBJECT   ID=MYOCX   width=1600  height=32
	CODEBASE=http://10.20.67.133:8080/myocx.cab
	CLASSID="CLSID:F0E9CC0B-A281-41A0-BCCD-E12E4039063A">   
  </OBJECT> -->
<div id="main">
        ...
        <div class="navbar-inner">
            ...
            <div class="nav-collapse">
                <ul id="menu" class="nav">
                    ...
                    <c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
                        <c:if test="${menu.parent.id eq '1' && menu.isShow eq '1'}">
                            ...
                            <c:if test="${menu.target != null}">
                                <li class="menu ${firstMenu ? ' active' : ''}"><a class="menu" href="${ctx}${menu.href}"
                ...
                <ul class="nav pull-right">
                    <%--	             <li id="themeSwitch" class="dropdown" id="switch">--%>
                    <%--	             	 <a class="dropdown-toggle" data-toggle="dropdown" href="#" title="收起" onclick="switchUp()" id="a1"><i class="icon-chevron-up" id="li1"></i></a>--%>
                    <%--	             </li>--%>
                    <!-- 
    ...
    <div class="container-fluid" id="iframe">
        <div id="content" class="row-fluid" id="middle">
            <div id="left">
        ...
        <div id="footer" class="row-fluid">
            Copyright &copy; 2015-${fns:getConfig('copyrightYear')} 业务管理站点
        </div>
    </div>
</div>
<script type="text/javascript">
