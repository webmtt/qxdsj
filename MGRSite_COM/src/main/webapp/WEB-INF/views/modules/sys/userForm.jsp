	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#areaList").change(function(){
				var optionValue=$("#areaList option:selected").val();
				if(optionValue!="0"){
					$("#areaId").attr("value",optionValue);
				}
			});
			$("#loginName").focus();
			$("#inputForm").validate({
...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
	   ...
	   <%--  <div class="control-group">
		...
		<%-- <div class="control-group">
			<label class="control-label">工号密码:</label>
			<div class="controls">
				<input id="noPassword" name="noPassword" type="text" value="${user.noPassword}" maxlength="50" minlength="3" class="required"/>
			</div>
		</div> --%>
		<div class="control-group">
