...
<body>
	<ul class="nav nav-tabs">
		<li ><a href="${ctx}/friendLink/list">相关链接列表</a></li>
		 <li class="active"><a href="${ctx}/friendLink/add">新增相关链接</a></li> 
	</ul>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="chnname" htmlEscape="false" maxlength="50"
						class="required" />
				<span style="color: red;margin:0px 6px;">*</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">相关链接类型:</label>
			<div class="controls">
				<form:radiobuttons path="linktype" items="${fns:getDictList('friendLink')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
				<span style="color: red;margin:0px 6px;">*</span>
			</div>
		</div>
		<div class="control-group">
