...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/funcItmesDef/toEdit?pid=${pid}&funcitemid=${funcitemid}">编辑栏目</a></li>
	</ul>
	
	<tags:message content="${message}"/>
	<form:form id="inputForm" modelAttribute="funcItmesDef" action="${ctx}/funcItmesDef/edit" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return check()">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="keyWord" id="keyWord" htmlEscape="false" cssStyle="width:350px;"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="linkUrl" id="linkUrl" htmlEscape="false" class="required" cssStyle="width:350px;"/>
			</div>
	    </div>
