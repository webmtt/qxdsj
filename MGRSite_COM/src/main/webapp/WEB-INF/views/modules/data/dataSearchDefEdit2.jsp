...
<body>
	...
	<form:form id="inputForm" modelAttribute="dataSearchDef" action="${ctx}/dataSearchDef/saveupdateDataSearch2" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return check()">
	...
	<div class="control-group">
	 ...
	 <div class="control-group">
		...
		<div class="controls">				
			<input type="text" name="datachnname" id="datachnname"  value="${dataSearchDef.datachnname}" htmlEscape="false" cssStyle="width:350px;"/>
	 ...
	 <div class="control-group">
		...
		<div class="controls">				
			<input type="text" name="searchname" id="searchname" value="${dataSearchDef.searchname}" htmlEscape="false" cssStyle="width:350px;"/>
			<span style="color:red;">*</span>
		</div>
	</div>
	 <div class="control-group">
		...
		<div class="controls">				
			<input type="text" name="udatacode" id="udatacode"  value="${dataSearchDef.udatacode}" htmlEscape="false" cssStyle="width:350px;"/>
