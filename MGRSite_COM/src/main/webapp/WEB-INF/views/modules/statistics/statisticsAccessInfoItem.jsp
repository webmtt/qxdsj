...
<script type="text/javascript"
	src="${ctxStatic}/ultra/js/statistics/statisticsAccessInfoItem.js?ver=4"></script>
<link rel="stylesheet" type="text/css"
						...
						<div class="filters">
							...
							<div class="form">
								<div class="inputs">
									...
									<span class="btnTippp" style="font-size:12px;"><font
										color="#E65221">请选择一级栏目</font></span>
								</div>
							</div>
							<div class="form">
							    <div class="inputs" style="color:#3580cd;font-weight:bold;">栏目维度查询:</div>
								<div class="inputs">
									<strong>起始年月</strong><input id="startTime" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM'})" class="WdateSearch"/>
									至<input id="endTime" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM'})" class="WdateSearch"/>
							...
							<div class="form">
								<div class="inputs">
									...
									至<input id="endTime2" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="WdateSearch"/>
									 <a id="btn2" href="#"
