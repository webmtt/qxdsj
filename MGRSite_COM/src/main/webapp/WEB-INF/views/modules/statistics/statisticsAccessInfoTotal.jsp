...
<script type="text/javascript"
	src="${ctxStatic}/ultra/js/statistics/statisticsAccessInfoTotal.js?ver=4"></script>
<link rel="stylesheet" type="text/css"
				...
				<div class="col">
					...
					<form name="calendar" method="get">
						<div class="filters">
							...
							<div class="form">
								<div class="inputs">
									<strong>起始年月日时 </strong> <input id="startTime3" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH'})" class="WdateSearch"/>
									至 <input id="endTime3" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH'})" class="WdateSearch"/>
