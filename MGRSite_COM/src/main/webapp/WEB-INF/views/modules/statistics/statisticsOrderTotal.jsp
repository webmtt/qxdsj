...
<link rel="stylesheet" type="text/css" href="${ctxStatic}/ultra/css/statistics/statisticsDownloadTotal.css?ver=1" />
...
<script type="text/javascript" src="${ctxStatic}/ultra/js/statistics/statisticsOrderTotal.js?ver=1"></script>
