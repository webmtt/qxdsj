...
<link rel="stylesheet" type="text/css" href="${ctxStatic}/ultra/css/statistics/statisticsDownloadCenter.css" />
...
<script type="text/javascript" src="${ctxStatic}/ultra/js/statistics/statisticsDownloadCenter.js"></script>
