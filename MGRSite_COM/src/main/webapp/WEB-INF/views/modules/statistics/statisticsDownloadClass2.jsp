...
<link rel="stylesheet" type="text/css" href="${ctxStatic}/script/jquery-easyui-1.2.6/themes/default/easyui.css" />
...
<link rel="stylesheet" type="text/css" href="${ctxStatic}/ultra/css/statistics/statisticsDownloadClass.css" />
...
<script type="text/javascript" src="${ctxStatic}/ultra/js/statistics/statisticsDownloadClass.js"></script>
							...
							<div class="form">
								<div class="inputs">
									...
									<span style="padding:0px 0px 0px 1px;"> 
										<a id="btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true">
											确定查询
										</a>
							...
							<div class="form">
								<div class="inputs">
									<strong>自定义起始年月 </strong>
									 ...
									 <a id="btn2" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true">
										 确定查询
									 </a>
								</div>
