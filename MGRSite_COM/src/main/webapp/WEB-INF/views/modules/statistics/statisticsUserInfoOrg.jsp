...
<script type="text/javascript"
	src="${ctxStatic}/ultra/js/statistics/statisticsUserInfoOrg.js?ver=3"></script>
<link rel="stylesheet" type="text/css"
				...
				<div class="col">
					...
					<form name="calendar" method="get">
						<div class="filters">
							...
							<div class="form">
								<div class="inputs">
									<strong>起始年月日 </strong> <input id="startTime" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="WdateSearch"/>
									至 <input id="endTime" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="WdateSearch"/>
