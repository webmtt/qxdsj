...
<head>
	...
	<script type="text/javascript"
			src="${ctxStatic}/ultra/js/statistics/statisticsUserInfoTotal.js?ver=1"></script>
	<link rel="stylesheet" type="text/css"
			...
			<div class="col">
				...
				<form name="calendar" method="get">
					<div class="filters">
						...
						<div class="form">
							<div class="inputs">
								<strong>起始年   </strong> <input id="startTime1" type="text" onclick="WdatePicker({dateFmt:'yyyy'})" class="WdateSearch"/>
								至 <input id="endTime1" type="text" onclick="WdatePicker({dateFmt:'yyyy'})" class="WdateSearch"/> <a id="btn1" href="#"
						...
						<div class="form">
							<div class="inputs">
								<strong>起始年月   </strong> <input id="startTime2" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM'})" class="WdateSearch"/>
								至 <input id="endTime2" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM'})" class="WdateSearch"/> <a id="btn2" href="#"
																																	   class="easyui-linkbutton"
																																	   data-options="iconCls:'icon-search',plain:true">确定查询</a>
								<span class="btnTip" style="font-size:12px;"><font
										color="#E65221"> 查询日期不能为空！</font></span>
						...
						<div class="form">
							<div class="inputs">
								<strong>起始年月日 </strong> <input id="startTime3" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="WdateSearch"/>
