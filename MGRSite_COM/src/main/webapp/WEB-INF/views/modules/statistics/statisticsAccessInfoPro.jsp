...
<script type="text/javascript"
	src="${ctxStatic}/ultra/js/statistics/statisticsAccessInfoPro.js?ver=2"></script>
<link rel="stylesheet" type="text/css"
			...
			<div class="content">
				<div class="col">
					...
					<form name="calendar" method="get">
						<div class="filters">
							<h3>气象数据统计平台 - 网站访问分省情况统计</h3>
							<div class="form">
								<div class="inputs">
									<strong>统计类型</strong> <input id="type" />
									<strong>选择省份</strong> 
										<input id="province" class="province"/> 
									</span>
								</div>
							</div>
							<div class="form">
