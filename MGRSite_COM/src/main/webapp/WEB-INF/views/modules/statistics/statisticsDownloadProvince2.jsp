...
<link rel="stylesheet" type="text/css" href="${ctxStatic}/ultra/css/statistics/statisticsDownloadProvince.css" />
...
<script type="text/javascript" src="${ctxStatic}/ultra/js/statistics/statisticsDownloadProvince.js"></script>
