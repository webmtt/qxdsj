...
<link rel="stylesheet" type="text/css" href="${ctxStatic}/ultra/css/statistics/statisticsDownloadCenter.css?ver=1" />
...
<script type="text/javascript" src="${ctxStatic}/ultra/js/statistics/statisticsDownloadCenter.js?ver=1"></script>
