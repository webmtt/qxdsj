...
//	        page.setCount(Long.valueOf(createQuery(countQlString, parameter).uniqueResult().toString()));
     ...
     * @return
     */
    public <E> List<E> find(String qlString, int maxIndex) {
        return find(qlString, null, maxIndex);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <E> List<E> find(String qlString, Parameter parameter, int maxIndex) {
        Query query = createQuery(qlString, parameter);
