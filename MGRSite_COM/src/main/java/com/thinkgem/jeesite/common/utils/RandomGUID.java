...
public class RandomGUID extends Object {
	...
	public String toString() {
		...
		StringBuffer sb = new StringBuffer();
		/*
		 * sb.append(raw.substring(0, 8)); sb.append("-"); sb.append(raw.substring(8, 12)); sb.append("-");
		 * sb.append(raw.substring(12, 16)); sb.append("-"); sb.append(raw.substring(16, 20)); sb.append("-");
	...
	/*public static void main(String args[]) throws Exception {
		 ...
		 * Thread.sleep(10000); for (int i = 0; i < 1000; i++) { RandomGUID myGUID = new RandomGUID(); //
		 * System.out.println("Seeding String=" + myGUID.valueBeforeMD5); // System.out.println("rawGUID=" +
		 * myGUID.valueAfterMD5); // System.out.println("RandomGUID=" + myGUID.toString());
		 * 
		 * System.out.println(myGUID.toString()); // System.out.println(myGUID.toString().replaceAll("-", ""));
		 * 
		 * }
