...
import com.thinkgem.jeesite.modules.sys.dao.LogDaoMgrsite;
...
public class LogServiceMgrsite extends BaseService {

	@Autowired
	private LogDaoMgrsite logDaoMgrsite;
	
	public Log get(String id) {
		return logDaoMgrsite.get(id);
	}
	
	public Page<Log> find(Page<Log> page, Map<String, Object> paramMap) {
		DetachedCriteria dc = logDaoMgrsite.createDetachedCriteria();
		...
		return logDaoMgrsite.find(page, dc);
	}
