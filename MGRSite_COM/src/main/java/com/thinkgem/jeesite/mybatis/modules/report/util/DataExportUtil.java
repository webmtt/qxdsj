package com.thinkgem.jeesite.mybatis.modules.report.util;
...
public class DataExportUtil {
  ...
  public static int exportToExcel(
      ...
      List<Map<String, Object>> objData,
      String sheetName,
      List<String> columns) {
    int flag = 0;
    ...
    try {
      ...
      //      WritableFont font2 =
      //          new WritableFont(WritableFont.createFont("微软雅黑"), 9, WritableFont.NO_BOLD);
        ...
        if (objData != null && objData.size() > 0) {
          ...
          for (int i = 0; i < objData.size(); i++) {
            ...
            for (Object o : map.keySet()) {
              ...
              String content = "";
              Object key=map.get(o);
              if(key!=null) {
                if (key.toString().contains(".")) {
//                  if(CommonUtil.isNumeric(key.toString())) {
//                    content = decimalFormat.format(Float.valueOf(key.toString()));
//                  }else{
...
//                  }
                  ...
                  content = String.valueOf(key).split("\\.")[0];
                  ws.addCell(new Label(j, i + 1, content));
                } else {
                  content = String.valueOf(key);
                  ws.addCell(new Label(j, i + 1, content));
