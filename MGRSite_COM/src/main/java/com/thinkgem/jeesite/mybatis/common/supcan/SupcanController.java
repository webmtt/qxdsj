 ...
 */
package com.thinkgem.jeesite.mybatis.common.supcan;
...
import com.thinkgem.jeesite.mybatis.common.utils.CacheUtils;
...
import com.thinkgem.jeesite.mybatis.common.supcan.annotation.treelist.SupTreeList;
import com.thinkgem.jeesite.mybatis.common.supcan.annotation.treelist.cols.SupCol;
import com.thinkgem.jeesite.mybatis.common.supcan.annotation.treelist.cols.SupGroup;
import com.thinkgem.jeesite.mybatis.common.supcan.treelist.TreeList;
import com.thinkgem.jeesite.mybatis.common.supcan.treelist.cols.Col;
import com.thinkgem.jeesite.mybatis.common.supcan.treelist.cols.Group;
...
public class SupcanController extends BaseController {
	...
	public TreeList treeList(@PathVariable("typeAlias") String typeAlias) {
		...
		try{
			// 根据别名获取MyBaits注册类型。
			SqlSessionFactory sqlSessionFactory = SpringContextMybatisHolder.getBean(SqlSessionFactory.class);
