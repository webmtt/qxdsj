...
<head>
    ...
    <title>气象大数据云平台 数据交换工具（KETTLE调度监控平台）</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element" style="display: flex;justify-content: flex-start;">
                        <%--<span><img alt="image" src="static/img/logo.jpg"></span>--%>
                        <span>
                            <img alt="image" src="static/img/logo-new.png" style=" width: auto;height: auto;" />
                        </span>
                    </div>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="view/data/listUI.shtml">&nbsp;数据分类</a>
                        </li>
                    </ul>
                </li>
                <li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header" style="width:80%" >
                    ...
                    <div class="navbar-title">气象大数据云平台 数据交换工具（KETTLE调度监控平台）</div>
                </div>
