...
<head>
	...
	<link href="static/js/layui-v2.5.5/layui/css/layui.css" rel="stylesheet" media="all">
</head>
<body class="gray-bg">
			...
			<%--<div class="ibox float-e-margins">--%>
				...
				<%--<div class="ibox-content" >--%>
					<%--<div class="layui-inline">--%>
						<%--<label class="layui-form-label">请选择时间范围</label>--%>
						<%--<div class="layui-input-inline">--%>
							<%--<input type="text" class="layui-input" id="betimes" placeholder="开始 到 结束" autocomplete="off" value="">--%>
						<%--</div>--%>
					<%--</div>--%>
					<%--<div class="echarts" id="bodyLines"></div>--%>
					<%--<div class="echarts" id="fileLines"></div>--%>
					<%--<div class="echarts" id="apiLines"></div>--%>
				<%--</div>--%>
			<%--</div>--%>
		<%--</div>--%>
	</div>
	...
	<script src="static/js/layui-v2.5.5/layui/layui.js" charset="utf-8"></script>
</body>
</html>