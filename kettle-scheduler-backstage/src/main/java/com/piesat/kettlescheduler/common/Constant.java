...
public class Constant extends Const {
    ...
    public static String KETTLE_PLUGIN_JSON;
...
//				+ props.getProperty("kettle.plugin");
        ...
        KETTLE_PLUGIN_JSON = props.getProperty("kettle.plugin.json");
    ...
    public static Properties readProperties() {
        ...
        File file = new File(CommonUtils.getJarRoot() + File.separator + UKETTLE);
        if (!file.exists()) {
            try {
            ...
            try {
                p.load(new FileInputStream(CommonUtils.getJarRoot() + File.separator + UKETTLE));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
