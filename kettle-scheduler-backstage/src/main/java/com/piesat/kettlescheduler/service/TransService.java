...
import com.piesat.kettlescheduler.mapper.KTransDao;
import com.piesat.kettlescheduler.mapper.KTransMonitorDao;
...
import com.piesat.kettlescheduler.quartz.TransQuartz;
...
//		Long allCount = kTransDao.templateCount(template);
    ...
    private Map<String, Object> getQuartzParameter(KTrans kTrans) {
        ...
        parameter.put(Constant.CATEGORY_ID, kTrans.getCategoryId());
    ...
    public List<KTrans> getByID(int categoryId) {
        return kTransDao.getByID(categoryId);
    }
}