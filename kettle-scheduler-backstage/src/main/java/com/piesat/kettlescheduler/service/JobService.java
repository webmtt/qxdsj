...
import com.piesat.kettlescheduler.common.exception.SeviceException;
...
import com.piesat.kettlescheduler.mapper.KJobMonitorDao;
import com.piesat.kettlescheduler.mapper.KQuartzDao;
import com.piesat.kettlescheduler.mapper.KRepositoryDao;
...
import com.piesat.kettlescheduler.quartz.JobQuartz;
import com.piesat.kettlescheduler.quartz.QuartzManager;
import com.piesat.kettlescheduler.quartz.model.DBConnectionModel;
import com.piesat.kettlescheduler.utils.CommonUtils;
...
//		Long allCount = kJobDao.templateCount(template);
    ...
    public void insert(KJob kJob, Integer uId, String customerQuarz) throws SQLException {
        ...
        /*String dataIds = "";
        for (int i = 0; i < kJob.getDataId().length; i++) {
            dataIds += kJob.getDataId()[i] + ",";
        }
        kJob.setDataIds(dataIds);
        kJobDao.insert(kJob);
    ...
    private Map<String, Object> getQuartzParameter(KJob kJob) {
        ...
        parameter.put(Constant.CATEGORY_ID, kJob.getCategoryId());
